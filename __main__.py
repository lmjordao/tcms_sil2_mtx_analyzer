...
from ccus_project_data import CcusProjectData
...
def main2():
    print('Initialising...')
    exporter = XLSXExporter('export')

    ccus_project_data = CcusProjectData()
    ccus_data = ccus_project_data.load_local_mtx_files()
    analysis_results = AnalysisTools().compare_signals_among_projects(ccus_data)

    exporter.export_signal_comparison_among_projects(analysis_results, 'signal_among_projects')
    exporter.save()
